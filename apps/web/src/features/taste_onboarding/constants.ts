...
export const VIBE_TAGS: Record<Genre, string[]> = {
  ...
  "Science Fiction": ["Mind-bending", "Dystopian", "Thought-provoking", "Cyberpunk"],
...
export const SEED_MOVIES = {
 ...
 'Comedy': [{'title': 'The Grand Budapest Hotel',
  ...
  {'title': 'Dr. Strangelove',
   'year': 1964,
   'vibes': ['Satirical'],
   'poster_url': 'https://image.tmdb.org/t/p/w500/7SixLzxcqezkZEYU8pcHZgbkmjp.jpg'},
 ...
 'Drama': [{'title': 'Moonlight',
  ...
  {'title': 'A Separation',
   'year': 2011,
   'vibes': ['Emotional', 'Character-driven'],
   'poster_url': 'https://image.tmdb.org/t/p/w500/wQVvASmpm8jGhJBQU20OkoMcNzi.jpg'},
 ...
 'Thriller': [{'title': 'The Silence of the Lambs',
  ...
  {'title': 'The Wages of Fear',
   ...
   'poster_url': 'https://image.tmdb.org/t/p/w500/dZyZSosIlWcpQkV0f7pXcrV2TQV.jpg'},
  {'title': 'Sicario',
   'year': 2015,
